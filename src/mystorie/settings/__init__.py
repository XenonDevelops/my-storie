"""
Django settings for mystorie project.
...
ADMINS = (
    (u'Angel Lagunas', 'al@manoderecha.mx'),
)

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'p9+fqw4=w3!ymhom$h$z#=b&h20_zsjuv=hrxp&c-i%96p-=c0'
...
ROOT_URLCONF = 'mystorie.urls'

WSGI_APPLICATION = 'mystorie.wsgi.application'
